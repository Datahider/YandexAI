...
class YandexSpeachKitGatewayTest extends TestCase {
    ...
    public function testPause() {
        ...
        $this->assertEquals("Можно еще\n\nНапример создать отдельный топик который будет называться баланс и собственно сумма баланса тогда каждый тот кому нужно может закрепить этот топик наверху группы и видеть баланс а кому не нужно для тех он уедет вниз и все", 
                $text);
    }
